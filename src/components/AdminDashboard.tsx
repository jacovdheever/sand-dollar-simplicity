...
import { Plus, Edit, Trash2, Eye, LogOut, FileText, Calendar, User, Tag, X, Briefcase, BarChart3, FileSearch } from 'lucide-react';
import ArticleUpload from './ArticleUpload';
import ArticleEdit from './ArticleEdit';
import ProjectUpload from './ProjectUpload';
import ProjectEdit from './ProjectEdit';
import AnalyticsDashboard from './AnalyticsDashboard';
import WebsiteAuditDashboard from './WebsiteAuditDashboard';
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'articles' | 'projects' | 'analytics' | 'audit'>('articles');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'audit' && (
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-center">
              <FileSearch className="w-16 h-16 text-[#f97316] mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Website Audit Tool</h3>
              <p className="text-gray-600 mb-6">
                Analyze client websites for usability, UX/UI design, SEO, performance, and more. 
                Generate comprehensive reports and actionable improvement prompts.
              </p>
              <button
                onClick={() => setShowAuditModal(true)}
                className="coral-gradient text-white px-6 py-3 rounded-lg hover:opacity-90 transition-opacity duration-200 flex items-center gap-2 mx-auto"
              >
          ...
          <>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold text-gray-900">
                {activeTab === 'articles' ? 'Articles' : 'Projects'}
              </h2>
              <button
              ...
              >
                ...
                {activeTab === 'articles' ? 'Upload New Article' : 'Create New Project'}
              </button>
            </div>
        ...
        {/* Empty State */}
        {((activeTab === 'articles' && articles.length === 0) || (activeTab === 'projects' && projects.length === 0)) && (
          <div className="text-center py-12">
            ...
            <div className="mt-6">
              ...
              >
                <Plus className="w-4 h-4 mr-2" />
                {activeTab === 'articles' ? 'Upload Article' : 'Create Project'}
              </button>
            </div>
          </div>
        )}
      ...
      {showEditModal && (
        <>
          {activeTab === 'articles' && articleToEdit ? (
            <ArticleEdit
            ...
            />
          ) : activeTab === 'projects' && projectToEdit ? (
            <ProjectEdit
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden">
              ...
              <div className="overflow-y-auto max-h-[calc(90vh-80px)] p-6">
                <div className="prose prose-lg max-w-none">
                  <div className="whitespace-pre-wrap">{selectedProject.content}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Website Audit Modal */}
      {showAuditModal && (
        <WebsiteAuditDashboard onClose={() => setShowAuditModal(false)} />
      )}
    </div>
  );
};
